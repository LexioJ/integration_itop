...
(function() {
    ...
    console.log('iTop Admin Settings: Loading event handlers for server-rendered template');

    // Wait for DOM to be ready
    document.addEventListener('DOMContentLoaded', function() {
        console.log('iTop Admin Settings: DOM ready, attaching event handlers');
        ...
        if (urlInput && urlInput.value.trim() !== '') {
            console.log('iTop Admin Settings: Auto-testing connection silently');
    ...
    function loadConnectedUsersCount() {
        ...
        .catch(error => {
            console.error('iTop Admin Settings: Failed to load connected users count:', error);
        });
    }

    function saveConfiguration() {
        console.log('iTop Admin Settings: Saving configuration');
        ...
        .catch(error => {
            console.error('iTop Admin Settings: Save error:', error);
    ...
    function testConnection(silent = false) {
        console.log('iTop Admin Settings: Testing connection' + (silent ? ' (silent)' : ''));
    ...
    function saveCacheSettings() {
        console.log('iTop Admin Settings: Saving cache settings');
        ...
        .catch(error => {
            console.error('iTop Admin Settings: Error saving cache settings:', error);
    ...
    function clearAllCache() {
        ...
        .catch(error => {
            console.error('iTop Admin Settings: Error clearing cache:', error);
    ...
    function saveCIClasses() {
        console.log('iTop Admin Settings: Saving CI class configuration');
        ...
        .catch(error => {
            console.error('iTop Admin Settings: Error saving CI classes:', error);
    ...
    function toggleAllCIClasses() {
        console.log('iTop Admin Settings: Toggling all CI classes');
        ...
        console.log('iTop Admin Settings: Toggled all to state:', targetState);
    }

    function checkAppVersion(currentVersion) {
        console.log('iTop Admin Settings: Checking for updates, current version:', currentVersion);
        ...
        .catch(error => {
            console.error('iTop Admin Settings: Version check error:', error);
        });
    }
